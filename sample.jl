...
#тот же мувлайн только с условиями на остановку и маркеры(маркеры пока не работают)
function moveline!(r, side::HorizonSide, mark_cond::Function, stop_cond::Function, steps::Int) 
    back = []
